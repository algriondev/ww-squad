...
const membershipLevels = [
  ...
  },
  {
    ...
    color: "#5ba3d9",
    label: "3-MONTH",
    sub: "Valid for 90 days",
    price: 17000,
    popular: true,
    perks: ["All gym access", "Best value"],
  },
  {
    id: "6month",
    color: "#ff8c42",
    label: "6-MONTH",
    sub: "Valid for 180 days",
    price: 32000,
    perks: ["All gym access"],
  },
  {
...
const studentLevels = [
  ...
  },
  {
    id: "student-peak-dd",
    color: "#b366cc",
    label: "PEAK DIRECT DEBIT",
    sub: "Min. 12 months commitment",
    price: 4500,
    perks: ["All hours", "Auto-renewal", "Valid ID required"],
  },
  {
    id: "student-offpeak",
    color: "#7ecfe3",
