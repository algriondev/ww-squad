...
const JoinModal = memo(({ onClose }: { onClose: () => void }) => {
  ...
  return (
    ...
    >
      {/* Minimal header - step 1-3 content goes here */}
      <div
        style={{
          position: "sticky",
          top: 0,
      ...
      <div style={{ padding: `12px ${isMobile ? "22px" : "40px"} 100px` }}>
        {step === 1 && (
          <div style={{ animation: "ww-fadeUp .45s ease", maxWidth: 580, margin: "0 auto" }}>
            ...
            <button onClick={() => setStep(2)} style={{ ...btnStyle(), marginTop: 26 }} onMouseDown={(e) => (e.currentTarget.style.transform = "scale(.96)")} onMouseUp={(e) => (e.currentTarget.style.transform = "scale(1)")}>
              CONTINUE →
            </button>
          </div>
        )}
        {step === 2 && (
          <div style={{ animation: "ww-fadeUp .45s ease", maxWidth: 520, margin: "0 auto" }}>
            ...
            <button onClick={() => setStep(3)} style={{ ...btnStyle(), marginTop: 26 }} onMouseDown={(e) => (e.currentTarget.style.transform = "scale(.96)")} onMouseUp={(e) => (e.currentTarget.style.transform = "scale(1)")}>
              REVIEW ORDER →
            </button>
          </div>
        )}
        {step === 3 && (
          <div style={{ animation: "ww-fadeUp .45s ease", maxWidth: 520, margin: "0 auto" }}>
            ...
            <button onClick={() => setConfirmed(true)} style={{ ...btnStyle(), marginTop: 26, padding: "17px", fontSize: 15 }} onMouseDown={(e) => (e.currentTarget.style.transform = "scale(.96)")} onMouseUp={(e) => (e.currentTarget.style.transform = "scale(1)")}>
